    ...
    const fetchCalendarData = async () => {
      ...
      try {
        ...
        if (facilityIds.length > 0) {
          // First, get bookings without the problematic users relationship
          ...
          // Then get user details separately if needed
          ...
          if (enrichedBookings.length > 0) {
            ...
            if (userIds.length > 0) {
              try {
                ...
                console.warn('Could not fetch user details:', userFetchError);
                // Continue without user details
                enrichedBookings = enrichedBookings.map(booking => ({
                  ...booking,
                  users: { username: 'Unknown User' }
