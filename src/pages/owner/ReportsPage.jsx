...
function ReportsPage() {
  ...
  // RETAINED TIMEFRAME STATE FOR DYNAMIC REPORTING
  const [timeframe, setTimeframe] = useState("30days"); // Default report period set to 30 days
  ...
  useEffect(() => {
    const fetchDashboardStats = async () => {
      ...
      setLoading(true);
      try {
        // RETAINED DYNAMIC DAYS CALCULATION FOR REPORTS
        const days = timeframe === "7days" ? 7 : timeframe === "90days" ? 90 : 30;
        
        // RPC Call uses 'days' to fetch weekly, monthly, or quarterly data
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-white to-light-green-bg/30">
      <div className="container mx-auto px-6 py-8 max-w-7xl">
        ...
        {/* Premium Header - MODIFIED TITLE and RETAINED TIMEFRAME SELECTOR */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {/* Note: In Reports, "Monthly Revenue" and "MoM Growth" are highly relevant KPIs */}
          <KpiCard 
            icon={<FaRupeeSign />} 
          ...
          <KpiCard 
            ...
            value={`₹${stats.monthly_revenue.toLocaleString("en-IN")}`} 
            growth={stats.mom_revenue_growth} // RETAINED growth for comparison
          />
          <KpiCard 
            icon={<FaChartLine />} 
          ...
          <KpiCard 
            ...
            subtitle={`Across the last ${timeframe === '7days' ? '7 days' : timeframe === '30days' ? '30 days' : '90 days'}`}
          />
        </div>

        {/* Charts Section */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Revenue Trend - RETAINED TITLE AND LOGIC */}
